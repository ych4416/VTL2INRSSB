...
This site has also VTL-2 Programming Language interpreter in native RSSB machine code. VTL-2 in RSSB is about 18000 machine words long.
...
<<<<<<< HEAD
Many RSSBers have proven that RSSB is Turing Complete, and described primitives operations written in RSSB such like Load/Store/Move data, conditional jump, etc. However I can't find out anyone goes further. It might provide some new experiences in programming of practical apps in RSSB. Thus I am trying to explore to search for them.

## PLAY GROUND ##
You can play programming RSSB machine on a playground site https://ych4416.github.io/VTL2INRSSB/vtlide.html by writing its assembly language with macro definition feature. 
=======
## PLAY GROUND ##
...
<<<<<<< HEAD
2. The exeample of grouding up primitive operations programming in RSSB such as moving data, halting, basic arithmetics, jump, conditional jump, etc. See https://note.com/kste9947/n/n65a22a2b80d6 and its following articles. They are written in Japanese as my native. Use translation them as you need.
=======
