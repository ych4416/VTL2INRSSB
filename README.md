### This site provides an one-instruction-set-computer IDE and its VTL-2 interpreter.
...
This Emulator implements in JavaScript with refer to [https://github.com/electrodude/rssb](https://github.com/electrodude/rssb) (written in C).
...
2.  The exeample of grouding up primitive operations programming in RSSB such as moving data, halting, basic arithmetics, jump, contional jump, etc. See [https://note.com/kste9947/n/n65a22a2b80d6](https://note.com/kste9947/n/n65a22a2b80d6) and this following articles. They are written in Japanese as my native. Use translate them as you need.
